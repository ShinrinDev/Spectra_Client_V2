...
const ChartOne: React.FC = () => {
  ...
  return (
    <div className="col-span-12 rounded-sm border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-customDarkGray sm:px-7.5 xl:col-span-8">
        ...
        <div className="flex w-full flex-wrap gap-3 sm:gap-5">
          ...
          <div className="flex min-w-47.5">
           {/** <span className="mt-1 mr-2 flex h-4 w-full max-w-4 items-center justify-center rounded-full border border-secondary">
            ...
            <div className="w-full">
              <p className="font-semibold text-secondary">Spectra Leads</p>
              <p className="text-sm font-medium">12.11.2024 - 12.11.2024</p>
            </div> */}
          </div>
        </div>
